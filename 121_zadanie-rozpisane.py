...
def solution(expenses):
    """Function calculates the expenses from the start of the month up to and including the first Sunday. The function returns date and the median of these expenses, or None if there are no expenses"""
