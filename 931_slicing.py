...
def python_py_checker_func(some_string: str) -> bool:
    """Function that checks whether a string starts with python and ends with .py"""
    if some_string.startswith("python") and some_string.endswith(".py"):
        return True
    else:
        return False
...
#     """Testh of function that checks whether a string starts with python and ends with .py"""
...
def other_python_py_checker_func(some_other_string: str) -> bool:
    if some_other_string[0:6] == "python" and some_other_string[-3:] == ".py":
        return True
    else:
        return False
