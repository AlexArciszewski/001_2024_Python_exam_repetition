...
class Employee:
    ...
    def __repr__(self) -> str:
        return f"This is my current  2nd job I am {self.name} {self.last_name}"
    
    
    def __str__(self) -> str:
        return f"This is my current job I am {self.name} {self.last_name}"
        
    #metoda statyczna bez argumentu jej wywołanie da stringa
    @staticmethod
    def work():
        print("Uaa I'm workin' on it Boss")
    #metoda symulująca klasę 
    @classmethod
...
def main():
    ...
    print(codemaster_001.create_new_guy("Ala","maKota",200))
    # option = "monthly"
    # if option =='monthly':
