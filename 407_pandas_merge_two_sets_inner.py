#Zadanie 3. Połącz zbior_scalony razem ze zbiorem 3 na podstawie imion, tak aby zostały użyte jedynie obserwacje,
# które znajdują się w obu zbiorach
...
#zbior scalony ze zbiorem 3 inner czyli na podstawie wartosci w jednym i drugim zbiorze ktorymi sa imiona
pd.merge(zbior_scalony, zbior3, how='inner', on='Imię')
