...
#powstał wykres rozrzutu przy danej marce jest kropka na poziomie odpowiadającej liczbie aut.
plt.scatter(manufacturer_counts.index, manufacturer_counts.values, alpha=.2)
